...
#_state_size_with_prefix = rnn_cell_impl._concat
...
def _dynamic_rnn_loop(cell,
  ...
  def _create_zero_arrays(size):
    ...
    #size = _state_size_with_prefix(prefix=[batch_size],suffix=size)
  ...
  for output, output_size in zip(final_outputs, flat_output_size):
    ...
    #shape = _state_size_with_prefix(prefix=[const_time_steps, const_batch_size],suffix=output_size)
